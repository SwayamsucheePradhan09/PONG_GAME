...
Ball::Ball() {
    ...
    ballPixelPerSecX = 1980.0f / ballSpeed;
    ballPixelPerSecy = 1020.0f / ballSpeed;
}
...
// Reverses horizontal direction if it hits the right wall
...
// Handles ball going below the screen (player misses)
